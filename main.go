...
func main() {
	...
	client, err = firestore.NewClient(ctx, "qwiklabs-gcp-00-cfa93bfea4ee")
	if err != nil {
...
// Agregue asistencia al controlador en la parte inferior del archivo:
...
// Agregue asistencia al cliente al final del archivo:
